...
public class cl_uint4 {
    ...
    private static final OfInt x$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$941:18"), groupElement("x"));
    ...
    private static final OfInt y$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$941:18"), groupElement("y"));
    ...
    private static final OfInt z$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$941:18"), groupElement("z"));
    ...
    private static final OfInt w$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$941:18"), groupElement("w"));
    ...
    private static final OfInt s0$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$942:18"), groupElement("s0"));
    ...
    private static final OfInt s1$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$942:18"), groupElement("s1"));
    ...
    private static final OfInt s2$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$942:18"), groupElement("s2"));
    ...
    private static final OfInt s3$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$942:18"), groupElement("s3"));
    ...
    private static final GroupLayout lo$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$943:18"), groupElement("lo"));
    ...
    private static final GroupLayout hi$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$943:18"), groupElement("hi"));
