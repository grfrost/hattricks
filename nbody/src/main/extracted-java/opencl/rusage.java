...
public class rusage {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        opencl_h.C_LONG.withName("ru_maxrss"),
        opencl_h.C_LONG.withName("ru_ixrss"),
        opencl_h.C_LONG.withName("ru_idrss"),
        opencl_h.C_LONG.withName("ru_isrss"),
        opencl_h.C_LONG.withName("ru_minflt"),
        opencl_h.C_LONG.withName("ru_majflt"),
        opencl_h.C_LONG.withName("ru_nswap"),
        opencl_h.C_LONG.withName("ru_inblock"),
        opencl_h.C_LONG.withName("ru_oublock"),
        opencl_h.C_LONG.withName("ru_msgsnd"),
        opencl_h.C_LONG.withName("ru_msgrcv"),
        opencl_h.C_LONG.withName("ru_nsignals"),
        opencl_h.C_LONG.withName("ru_nvcsw"),
        opencl_h.C_LONG.withName("ru_nivcsw")
    ).withName("rusage");
