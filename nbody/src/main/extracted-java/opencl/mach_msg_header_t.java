...
public class mach_msg_header_t {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        opencl_h.C_INT.withName("msgh_bits"),
        opencl_h.C_INT.withName("msgh_size"),
        opencl_h.C_INT.withName("msgh_remote_port"),
        opencl_h.C_INT.withName("msgh_local_port"),
        opencl_h.C_INT.withName("msgh_voucher_port"),
        opencl_h.C_INT.withName("msgh_id")
    ).withName("$anon$416:9");
