...
public class cl_uchar4 {
    ...
    private static final OfByte x$LAYOUT = (OfByte)$LAYOUT.select(groupElement("$anon$642:18"), groupElement("x"));
    ...
    private static final OfByte y$LAYOUT = (OfByte)$LAYOUT.select(groupElement("$anon$642:18"), groupElement("y"));
    ...
    private static final OfByte z$LAYOUT = (OfByte)$LAYOUT.select(groupElement("$anon$642:18"), groupElement("z"));
    ...
    private static final OfByte w$LAYOUT = (OfByte)$LAYOUT.select(groupElement("$anon$642:18"), groupElement("w"));
    ...
    private static final OfByte s0$LAYOUT = (OfByte)$LAYOUT.select(groupElement("$anon$643:18"), groupElement("s0"));
    ...
    private static final OfByte s1$LAYOUT = (OfByte)$LAYOUT.select(groupElement("$anon$643:18"), groupElement("s1"));
    ...
    private static final OfByte s2$LAYOUT = (OfByte)$LAYOUT.select(groupElement("$anon$643:18"), groupElement("s2"));
    ...
    private static final OfByte s3$LAYOUT = (OfByte)$LAYOUT.select(groupElement("$anon$643:18"), groupElement("s3"));
    ...
    private static final GroupLayout lo$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$644:18"), groupElement("lo"));
    ...
    private static final GroupLayout hi$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$644:18"), groupElement("hi"));
