...
public class cl_long8 {
    ...
    private static final OfLong x$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$1034:18"), groupElement("x"));
    ...
    private static final OfLong y$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$1034:18"), groupElement("y"));
    ...
    private static final OfLong z$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$1034:18"), groupElement("z"));
    ...
    private static final OfLong w$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$1034:18"), groupElement("w"));
    ...
    private static final OfLong s0$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$1035:18"), groupElement("s0"));
    ...
    private static final OfLong s1$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$1035:18"), groupElement("s1"));
    ...
    private static final OfLong s2$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$1035:18"), groupElement("s2"));
    ...
    private static final OfLong s3$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$1035:18"), groupElement("s3"));
    ...
    private static final OfLong s4$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$1035:18"), groupElement("s4"));
    ...
    private static final OfLong s5$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$1035:18"), groupElement("s5"));
    ...
    private static final OfLong s6$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$1035:18"), groupElement("s6"));
    ...
    private static final OfLong s7$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$1035:18"), groupElement("s7"));
    ...
    private static final GroupLayout lo$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$1036:18"), groupElement("lo"));
    ...
    private static final GroupLayout hi$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$1036:18"), groupElement("hi"));
