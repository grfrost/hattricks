...
public class sigevent {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        opencl_h.C_INT.withName("sigev_notify"),
        opencl_h.C_INT.withName("sigev_signo"),
        sigval.layout().withName("sigev_value"),
        opencl_h.C_POINTER.withName("sigev_notify_function"),
        opencl_h.C_POINTER.withName("sigev_notify_attributes")
    ).withName("sigevent");
    ...
    public static class sigev_notify_function {
        ...
        private static final MethodHandle UP$MH = opencl_h.upcallHandle(sigev_notify_function.Function.class, "apply", $DESC);
