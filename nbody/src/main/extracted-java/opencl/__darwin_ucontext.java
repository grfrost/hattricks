...
public class __darwin_ucontext {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        opencl_h.C_INT.withName("uc_onstack"),
        opencl_h.C_INT.withName("uc_sigmask"),
        __darwin_sigaltstack.layout().withName("uc_stack"),
        opencl_h.C_POINTER.withName("uc_link"),
        opencl_h.C_LONG.withName("uc_mcsize"),
        opencl_h.C_POINTER.withName("uc_mcontext")
