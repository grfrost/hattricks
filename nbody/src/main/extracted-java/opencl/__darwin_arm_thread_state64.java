...
public class __darwin_arm_thread_state64 {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.sequenceLayout(29, opencl_h.C_LONG_LONG).withName("__x"),
        opencl_h.C_LONG_LONG.withName("__fp"),
        opencl_h.C_LONG_LONG.withName("__lr"),
        opencl_h.C_LONG_LONG.withName("__sp"),
        opencl_h.C_LONG_LONG.withName("__pc"),
        opencl_h.C_INT.withName("__cpsr"),
        opencl_h.C_INT.withName("__pad")
