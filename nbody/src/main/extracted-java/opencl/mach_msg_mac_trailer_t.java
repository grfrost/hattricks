...
public class mach_msg_mac_trailer_t {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        opencl_h.C_INT.withName("msgh_trailer_type"),
        opencl_h.C_INT.withName("msgh_trailer_size"),
        opencl_h.C_INT.withName("msgh_seqno"),
        security_token_t.layout().withName("msgh_sender"),
        audit_token_t.layout().withName("msgh_audit"),
        opencl_h.align(opencl_h.C_LONG, 4).withName("msgh_context"),
        opencl_h.C_INT.withName("msgh_ad"),
