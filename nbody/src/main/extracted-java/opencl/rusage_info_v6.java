...
public class rusage_info_v6 {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.sequenceLayout(16, opencl_h.C_CHAR).withName("ri_uuid"),
        opencl_h.C_LONG_LONG.withName("ri_user_time"),
        opencl_h.C_LONG_LONG.withName("ri_system_time"),
        opencl_h.C_LONG_LONG.withName("ri_pkg_idle_wkups"),
        opencl_h.C_LONG_LONG.withName("ri_interrupt_wkups"),
        opencl_h.C_LONG_LONG.withName("ri_pageins"),
        opencl_h.C_LONG_LONG.withName("ri_wired_size"),
        opencl_h.C_LONG_LONG.withName("ri_resident_size"),
        opencl_h.C_LONG_LONG.withName("ri_phys_footprint"),
        opencl_h.C_LONG_LONG.withName("ri_proc_start_abstime"),
        opencl_h.C_LONG_LONG.withName("ri_proc_exit_abstime"),
        opencl_h.C_LONG_LONG.withName("ri_child_user_time"),
        opencl_h.C_LONG_LONG.withName("ri_child_system_time"),
        opencl_h.C_LONG_LONG.withName("ri_child_pkg_idle_wkups"),
        opencl_h.C_LONG_LONG.withName("ri_child_interrupt_wkups"),
        opencl_h.C_LONG_LONG.withName("ri_child_pageins"),
        opencl_h.C_LONG_LONG.withName("ri_child_elapsed_abstime"),
        opencl_h.C_LONG_LONG.withName("ri_diskio_bytesread"),
        opencl_h.C_LONG_LONG.withName("ri_diskio_byteswritten"),
        opencl_h.C_LONG_LONG.withName("ri_cpu_time_qos_default"),
        opencl_h.C_LONG_LONG.withName("ri_cpu_time_qos_maintenance"),
        opencl_h.C_LONG_LONG.withName("ri_cpu_time_qos_background"),
        opencl_h.C_LONG_LONG.withName("ri_cpu_time_qos_utility"),
        opencl_h.C_LONG_LONG.withName("ri_cpu_time_qos_legacy"),
        opencl_h.C_LONG_LONG.withName("ri_cpu_time_qos_user_initiated"),
        opencl_h.C_LONG_LONG.withName("ri_cpu_time_qos_user_interactive"),
        opencl_h.C_LONG_LONG.withName("ri_billed_system_time"),
        opencl_h.C_LONG_LONG.withName("ri_serviced_system_time"),
        opencl_h.C_LONG_LONG.withName("ri_logical_writes"),
        opencl_h.C_LONG_LONG.withName("ri_lifetime_max_phys_footprint"),
        opencl_h.C_LONG_LONG.withName("ri_instructions"),
        opencl_h.C_LONG_LONG.withName("ri_cycles"),
        opencl_h.C_LONG_LONG.withName("ri_billed_energy"),
        opencl_h.C_LONG_LONG.withName("ri_serviced_energy"),
        opencl_h.C_LONG_LONG.withName("ri_interval_max_phys_footprint"),
        opencl_h.C_LONG_LONG.withName("ri_runnable_time"),
        opencl_h.C_LONG_LONG.withName("ri_flags"),
        opencl_h.C_LONG_LONG.withName("ri_user_ptime"),
        opencl_h.C_LONG_LONG.withName("ri_system_ptime"),
        opencl_h.C_LONG_LONG.withName("ri_pinstructions"),
        opencl_h.C_LONG_LONG.withName("ri_pcycles"),
        opencl_h.C_LONG_LONG.withName("ri_energy_nj"),
        opencl_h.C_LONG_LONG.withName("ri_penergy_nj"),
        MemoryLayout.sequenceLayout(14, opencl_h.C_LONG_LONG).withName("ri_reserved")
