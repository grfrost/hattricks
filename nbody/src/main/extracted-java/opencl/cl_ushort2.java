...
public class cl_ushort2 {
    ...
    private static final OfShort x$LAYOUT = (OfShort)$LAYOUT.select(groupElement("$anon$779:18"), groupElement("x"));
    ...
    private static final OfShort y$LAYOUT = (OfShort)$LAYOUT.select(groupElement("$anon$779:18"), groupElement("y"));
    ...
    private static final OfShort s0$LAYOUT = (OfShort)$LAYOUT.select(groupElement("$anon$780:18"), groupElement("s0"));
    ...
    private static final OfShort s1$LAYOUT = (OfShort)$LAYOUT.select(groupElement("$anon$780:18"), groupElement("s1"));
    ...
    private static final OfShort lo$LAYOUT = (OfShort)$LAYOUT.select(groupElement("$anon$781:18"), groupElement("lo"));
    ...
    private static final OfShort hi$LAYOUT = (OfShort)$LAYOUT.select(groupElement("$anon$781:18"), groupElement("hi"));
