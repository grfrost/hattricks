...
public class __darwin_pthread_handler_rec {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        opencl_h.C_POINTER.withName("__routine"),
        opencl_h.C_POINTER.withName("__arg"),
    ...
    public static class __routine {
        ...
        private static final MethodHandle UP$MH = opencl_h.upcallHandle(__routine.Function.class, "apply", $DESC);
