...
public class cl_uint2 {
    ...
    private static final OfInt x$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$928:18"), groupElement("x"));
    ...
    private static final OfInt y$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$928:18"), groupElement("y"));
    ...
    private static final OfInt s0$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$929:18"), groupElement("s0"));
    ...
    private static final OfInt s1$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$929:18"), groupElement("s1"));
    ...
    private static final OfInt lo$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$930:18"), groupElement("lo"));
    ...
    private static final OfInt hi$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$930:18"), groupElement("hi"));
