 ...
 * }
 */
public class os_workgroup_join_token_opaque_s {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.sequenceLayout(36, opencl_h.C_CHAR).withName("opaque")
    ).withName("os_workgroup_join_token_opaque_s");
    ...
    private static long[] opaque$DIMS = { 36 };
