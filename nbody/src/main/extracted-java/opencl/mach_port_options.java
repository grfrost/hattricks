...
public class mach_port_options {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        opencl_h.C_INT.withName("flags"),
        mach_port_limits.layout().withName("mpl"),
        MemoryLayout.unionLayout(
            MemoryLayout.sequenceLayout(2, opencl_h.C_LONG_LONG).withName("reserved"),
            opencl_h.C_INT.withName("work_interval_port"),
            opencl_h.C_POINTER.withName("service_port_info"),
            opencl_h.C_INT.withName("service_port_name")
        ).withName("$anon$381:2")
    ...
    private static final SequenceLayout reserved$LAYOUT = (SequenceLayout)$LAYOUT.select(groupElement("$anon$381:2"), groupElement("reserved"));
    ...
    private static final OfInt work_interval_port$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$381:2"), groupElement("work_interval_port"));
    ...
    private static final AddressLayout service_port_info$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("$anon$381:2"), groupElement("service_port_info"));
    ...
    private static final OfInt service_port_name$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$381:2"), groupElement("service_port_name"));
