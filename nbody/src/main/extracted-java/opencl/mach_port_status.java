...
public class mach_port_status {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        opencl_h.C_INT.withName("mps_pset"),
        opencl_h.C_INT.withName("mps_seqno"),
        opencl_h.C_INT.withName("mps_mscount"),
        opencl_h.C_INT.withName("mps_qlimit"),
        opencl_h.C_INT.withName("mps_msgcount"),
        opencl_h.C_INT.withName("mps_sorights"),
        opencl_h.C_INT.withName("mps_srights"),
        opencl_h.C_INT.withName("mps_pdrequest"),
        opencl_h.C_INT.withName("mps_nsrequest"),
        opencl_h.C_INT.withName("mps_flags")
