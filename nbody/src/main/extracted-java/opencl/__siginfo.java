...
public class __siginfo {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        opencl_h.C_INT.withName("si_signo"),
        opencl_h.C_INT.withName("si_errno"),
        opencl_h.C_INT.withName("si_code"),
        opencl_h.C_INT.withName("si_pid"),
        opencl_h.C_INT.withName("si_uid"),
        opencl_h.C_INT.withName("si_status"),
        opencl_h.C_POINTER.withName("si_addr"),
        sigval.layout().withName("si_value"),
        opencl_h.C_LONG.withName("si_band"),
        MemoryLayout.sequenceLayout(7, opencl_h.C_LONG).withName("__pad")
    ).withName("__siginfo");
