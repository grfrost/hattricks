...
public class __darwin_arm_debug_state32 {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.sequenceLayout(16, opencl_h.C_INT).withName("__bvr"),
        MemoryLayout.sequenceLayout(16, opencl_h.C_INT).withName("__bcr"),
        MemoryLayout.sequenceLayout(16, opencl_h.C_INT).withName("__wvr"),
        MemoryLayout.sequenceLayout(16, opencl_h.C_INT).withName("__wcr"),
