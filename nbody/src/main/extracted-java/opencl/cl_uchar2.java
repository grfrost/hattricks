...
public class cl_uchar2 {
    ...
    private static final OfByte x$LAYOUT = (OfByte)$LAYOUT.select(groupElement("$anon$629:18"), groupElement("x"));
    ...
    private static final OfByte y$LAYOUT = (OfByte)$LAYOUT.select(groupElement("$anon$629:18"), groupElement("y"));
    ...
    private static final OfByte s0$LAYOUT = (OfByte)$LAYOUT.select(groupElement("$anon$630:18"), groupElement("s0"));
    ...
    private static final OfByte s1$LAYOUT = (OfByte)$LAYOUT.select(groupElement("$anon$630:18"), groupElement("s1"));
    ...
    private static final OfByte lo$LAYOUT = (OfByte)$LAYOUT.select(groupElement("$anon$631:18"), groupElement("lo"));
    ...
    private static final OfByte hi$LAYOUT = (OfByte)$LAYOUT.select(groupElement("$anon$631:18"), groupElement("hi"));
