...
public class cl_long2 {
    ...
    private static final OfLong x$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$1002:18"), groupElement("x"));
    ...
    private static final OfLong y$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$1002:18"), groupElement("y"));
    ...
    private static final OfLong s0$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$1003:18"), groupElement("s0"));
    ...
    private static final OfLong s1$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$1003:18"), groupElement("s1"));
    ...
    private static final OfLong lo$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$1004:18"), groupElement("lo"));
    ...
    private static final OfLong hi$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$1004:18"), groupElement("hi"));
