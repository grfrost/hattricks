...
public class __darwin_pthread_handler_rec {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        glut_h.C_POINTER.withName("__routine"),
        glut_h.C_POINTER.withName("__arg"),
        glut_h.C_POINTER.withName("__next")
    ...
    public static class __routine {
        ...
        private static final MethodHandle UP$MH = glut_h.upcallHandle(__routine.Function.class, "apply", $DESC);
